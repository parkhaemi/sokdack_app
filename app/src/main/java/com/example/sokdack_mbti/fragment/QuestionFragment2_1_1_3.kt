 ...
 */
class QuestionFragment2_1_1_3 : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.button_back_q2_1_1_3 -> {
                navController.navigate(R.id.action_questionFragment2_1_1_3_to_questionFragment2_1_1)
            }
        }
    }
