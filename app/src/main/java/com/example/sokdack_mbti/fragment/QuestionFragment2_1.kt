 ...
 */
class QuestionFragment2_1 : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.button_back_q2_1 -> {
                navController.navigate(R.id.action_questionFragment2_1_to_questionFragment1)
            }
        }
    }
